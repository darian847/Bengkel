                    ...
                    <div class="max-w-screen-xl px-4 mx-auto lg:px-12 w-3/3">
                        ...
                        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                            <section class="bg-white dark:bg-gray-900">
                                <div
                                    class=" items-center py-8 px-4 mx-auto max-w-screen-xl md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                                    <img class="w-2/3 dark:hidden rounded-3xl mx-auto"
                                        src="{{ asset('storage/LabelA.jpg') }}" alt="Label Normal">
                                    ...
                                    <div class="mt-4 md:mt-0">
                                        ...
                                        <form method="GET" action="/posts/showa" class="w-full mx-auto">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="search" name="slabela" id="search"
