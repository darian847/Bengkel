        ...
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <form method="POST" action="/posts">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">TANGGAL :</label>
                        <div class="relative">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div class="flex items-center ps-4 border border-gray-200 rounded-sm ">
                        ...
                        <label for="bordered-radio-1" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 ">Sudah
                            Input Bagian 1</label>
                    </div>
                    <div class="flex items-center ps-4 border border-gray-200 rounded-sm ">
                        <input checked id="bordered-radio-2" type="radio" value="Belum Input Bagian 1" name="sinput1"
                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500   focus:ring-2">
                        <label for="bordered-radio-2" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 ">Belum
                            Input Bagian 1</label>
                    </div>
                </div>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">TANGGAL PENGERJAAN
                            :</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                <svg class="w-4 h-4 text-gray-500 " aria-hidden="true"
                    ...
                    <div>
                        <label for="company" class="block mb-2 text-sm font-medium text-gray-900 ">YANG MENGERJAKAN :
                ...
                <div class="mb-6">
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 ">YANG MENYERAHKAN MOULD
                        :
