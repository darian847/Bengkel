...
<body>
    ...
    <main>
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="/posts/storea" class="max-w-sm mx-auto">
                @csrf
                <div class="mb-5">
                    <label for="nama-produk" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Nama
                        Produk</label>
                    <input type="text" id="nama-produk" name="namasa"
                ...
                <div class="mb-5">
                    <label for="batch-produk" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Baris
                        Yang Dihitamkan</label>
                    <input type="text" id="batch-produk" name="baris3"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="PETROKIMIA" required>
                </div>
                <button type="submit"
