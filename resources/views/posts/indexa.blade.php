                ...
                <ul>
                    @foreach ($labelas as $labela)
                        {{-- <div
                            ...
                            <a href="/posts/{{ $labela->id }}" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-w-xl hover:bg-gray-100">
                                ...
                                <div class="flex flex-col justify-between p-4 leading-normal">
                                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">{{ $labela->nospk }}</h5>
