    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        ...
        <div class="grid gap-8 lg:gap-16 sm:grid-cols-1 md:grid-cols-5 lg:grid-cols-5 ">
            <div class="text-center text-gray-500 dark:text-gray-400">
                <img class="mx-auto mb-4 w-36 h-36 rounded-2xl" src="{{ asset('storage/LabelNormal.jpg') }}"
                    alt="Label Normal">
                <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    <a href="/posts/create">Label CV</a>
                </h3>
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
                ...
                <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    <a href="/posts/createa">Label A</a>
                </h3>
                <p>Bentuk label dengan variasi A</p>

            </div>
            <div class="text-center text-gray-500 dark:text-gray-400">
                <img class="mx-auto mb-4 w-36 h-36 rounded-2xl" src="{{ asset('storage/LabelB.jpg') }}" alt="Label B">
                <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    <a href="#">Label B</a>
                </h3>
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
                <img class="mx-auto mb-4 w-36 h-36 rounded-2xl" src="{{ asset('storage/LabelNormalPT.jpg') }}"
                    alt="Label PT">
                <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    <a href="#">Label PT</a>
                </h3>
                <p>Bentuk label normal untuk PT</p>

            </div>
            <div class="text-center text-gray-500 dark:text-gray-400">
                <img class="mx-auto mb-4 w-36 h-36 rounded-2xl" src="{{ asset('storage/LabelSBD.jpg') }}"
                    alt="Label SBD">
                <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    <a href="#">Label SBD</a>
                </h3>
                <p>Bentuk label untuk produk SBD</p>
